...
function SetBoxLenght() {
  document.querySelector('body').style.height = document.body.clientHeight; //   console.log (screen.height)
...
function setBodyHeight() {
  document.querySelector('body').style = 'max-height: ' + document.body.clientHeight + 'px;';
}

;
document.addEventListener('DOMContentLoaded', function () {//   setBodyHeight ()
