...
function filesUpload(data) {
  ...
  for (var i = 0, file; file = data.target.files[i]; i++) {
    ...
    uploadToController(file); // var reader = new FileReader();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.getElementById('imgLoad').onchange = filesUpload; // document.querySelector('.gallery').ondrop = filesUpload
