...
@section('content')
    ...
    <div class="gallery-block">
        <div class="gallery">
            ...
            <?php // $minCountImageBoxInWindow = 29; ?>
            ...
            {{-- @if ($minCountImageBoxInWindow > 0)
                @for ($i = 0; $i < $minCountImageBoxInWindow; $i++)
                    <div class="image-empty-box"></div>
                @endfor
            @endif --}}
        </div>
