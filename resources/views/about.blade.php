...
@section('content')
    ...
    <div class="textblock">
        ...
        <p><b>tutuprint.ru</b> - сервис печати фотографий с доставкой. Наш багаж опыта и знаний в фотопечати начинается в
            ...
            наших
            фотографий.</p>
        <p><b>Печать со смартфона.</b> Сегодня у многих пользователей есть большое облачное храниличе с личными
            фотографиями. Со временем оно будет только расти. Распечатать важные снимки можно прямо с телефона в разделе <a
                href="{{ URL('gallery') }}">"Загрузка"</a>. В течении рабочего дня мы распечатаем ваш заказ, а после,
